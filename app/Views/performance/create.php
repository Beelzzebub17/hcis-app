...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0">Tambah Performance</h5>
    </div>
    <div class="card-body">
        <form action="/performance/store" method="post">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="period" id="period" class="form-control" placeholder="e.g., Jan 2025">
                </div>

                <div class="col-md-6 mb-3">
                    <label for="score" class="form-label">Score <span class="text-danger">*</span> (0-100)</label>
                    <input type="number" name="score" id="score" class="form-control" step="0.01" min="0" max="100" required>
                </div>
